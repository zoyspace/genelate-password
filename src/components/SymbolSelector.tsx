...
export function SymbolSelector({ selectedSymbols, onSymbolsChange, disabled }: SymbolSelectorProps) {
  ...
  return (
    <div className={`w-full space-y-4 ${disabled ? 'opacity-50 pointer-events-none' : ''}`}>
      <div className="flex justify-center mb-4">
        ...
        <Button variant="outline" size="sm" onClick={handleDeselectAll} disabled={disabled}>
          全て解除
        </Button>
      </div>
