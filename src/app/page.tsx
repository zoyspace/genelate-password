...
export default function PasswordGeneratorPage() {
  ...
  useEffect(() => {
    ...
    if (storedShouldGenerate) setShouldGeneratePassword(storedShouldGenerate === "true")
  }, [])
  ...
  }, [length, includeUppercase, includeNumbers, isDarkMode, customSymbols, includeSymbols, shouldGeneratePassword])
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            />
            <div>
              <label htmlFor="password-length-slider" className="block mb-2">Password Length: {length}</label>
              <Slider
            ...
            <div>
              <label htmlFor="custom-symbols-selector" className="block mb-2">Custom Symbols</label>
              <SymbolSelector
